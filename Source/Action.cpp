...
int CAction::GetAction() const { return m_iAction; }
...
int CActionHandler::GetUndoLevel() const { return m_UndoStack.size(); }

int CActionHandler::GetRedoLevel() const { return m_RedoStack.size(); }

bool CActionHandler::CanUndo() const { return !m_UndoStack.empty(); }

bool CActionHandler::CanRedo() const { return !m_RedoStack.empty(); }
