...
void CLinkLabel::OnMouseLeave() {
  ...
  rect.OffsetRect(-parentRect.left - GetSystemMetrics(SM_CXDLGFRAME),
                  -parentRect.top - GetSystemMetrics(SM_CYCAPTION) -
...
CAboutDlg::CAboutDlg()
    : CDialog(CAboutDlg::IDD), m_pMail(nullptr), m_pWeb(nullptr),
      m_pBug(nullptr), m_pLinkFont(nullptr), m_pBoldFont(nullptr),
      m_pTitleFont(nullptr), m_pHead(nullptr) {}
...
BOOL CAboutDlg::OnInitDialog() {
  ...
  SetDlgItemText(IDC_ABOUT_LIB,
                 ...
                 _T("- Fast Fourier Transform code is (C) 2017 Project Nayuki ")
                 _T("(MIT License)\r\n")
                 _T("- YM2413 emulator is written by Mitsutaka Okazaki\r\n")
                 _T("- FDS sound emulator from nezplug (including a fix by ")
                 _T("rainwarrior)\r\n")
