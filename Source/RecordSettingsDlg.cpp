...
ON_EN_KILLFOCUS(IDC_EDIT_RECORDER_INTERVAL, OnEnKillfocusEditRecorderInterval)
ON_EN_KILLFOCUS(IDC_EDIT_RECORDER_COUNT, OnEnKillfocusEditRecorderCount)
END_MESSAGE_MAP()
...
BOOL CRecordSettingsDlg::OnInitDialog() {
  ...
  CSpinButtonCtrl *pSpin =
      static_cast<CSpinButtonCtrl *>(GetDlgItem(IDC_SPIN_RECORDER_INTERVAL));
  ...
  CheckDlgButton(IDC_CHECK_RECORDER_RESET,
                 Setting->Reset ? BST_CHECKED : BST_UNCHECKED);
