...
public:
  ...
  bool ReadMessage(unsigned char &Message, unsigned char &Channel,
                   unsigned char &Data1, unsigned char &Data2);
  void WriteNote(unsigned char Channel, unsigned char Note,
...
private:
  ...
  void Enqueue(unsigned char MsgType, unsigned char MsgChannel,
               unsigned char Data1, unsigned char Data2);
...
private:
  //   static void CALLBACK MidiInProc(HMIDIIN hMidiIn, UINT wMsg, DWORD
  //   dwInstance, DWORD dwParam1, DWORD dwParam2);
  static void CALLBACK RtMidiInProc(double timeStamp,
