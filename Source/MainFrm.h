...
enum frame_edit_pos_t { FRAME_EDIT_POS_TOP, FRAME_EDIT_POS_LEFT };
...
enum { WM_USER_DISPLAY_MESSAGE_STRING = WM_USER, WM_USER_DISPLAY_MESSAGE_ID };
...
public:
  ...
  void SetSongInfo(const char *pName, const char *pArtist,
...
private:
  template <typename... T> void SetStatusText(LPCTSTR Text, T... args); // // //
...
private: // control bar embedded members
  ...
  CDialogBar
      m_wndControlBar; // Parent to frame editor and settings/instrument editor
