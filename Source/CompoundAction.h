...
/*!
        \brief A compound action class allowing multiple undoable actions to be
   chained together. \details The compound uniquely manages the action objects
   it contains.
*/
...
public:
  ...
  /*!	\brief Adds an action to the compound to be performed last (and undoed
     first). \param pAction Pointer to the action object. */
